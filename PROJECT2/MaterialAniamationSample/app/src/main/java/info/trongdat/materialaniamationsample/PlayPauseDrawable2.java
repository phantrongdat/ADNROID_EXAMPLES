...
/**
 * Created by Alone on 10/11/2016.
 */

public class PlayPauseDrawable2  extends Drawable {

    private static final Property<PlayPauseDrawable2, Float> PROGRESS =
            new Property<PlayPauseDrawable2, Float>(Float.class, "progress") {
                @Override
                public Float get(PlayPauseDrawable2 d) {
                    return d.getProgress();
                }

                @Override
                public void set(PlayPauseDrawable2 d, Float value) {
                    d.setProgress(value);
                }
            };
    ...
    public PlayPauseDrawable2(Context context) {
