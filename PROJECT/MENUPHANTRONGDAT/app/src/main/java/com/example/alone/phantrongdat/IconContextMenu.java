...
public class IconContextMenu extends ActionBarActivity {
    Button btnContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icon_context_menu);
        ...
        adap = new AdapterContextMenu(IconContextMenu.this, R.layout.context_menu_with_icon, arr);
