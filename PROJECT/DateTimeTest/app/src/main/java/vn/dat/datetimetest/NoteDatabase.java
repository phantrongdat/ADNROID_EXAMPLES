...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "datetime.sqlite";
    private static String DB_PATH = "/data/data/vn.dat.datetimetest/databases/";
...
//    }
    ...
    public void openDatabase() {
        if (dbExists()) {
            ...
            Toast.makeText(DB_CONTEXT, "Open database successfully .!", Toast.LENGTH_SHORT).show();
        } else {
            copyDatabase();
            Toast.makeText(DB_CONTEXT, "Copy database to SDCard successfully .!", Toast.LENGTH_SHORT).show();
        }
    }
