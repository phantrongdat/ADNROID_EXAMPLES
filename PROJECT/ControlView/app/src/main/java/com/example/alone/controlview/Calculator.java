...
public class Calculator extends ActionBarActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num0.setOnClickListener(Calculator.this);
        num1.setOnClickListener(Calculator.this);
        num2.setOnClickListener(Calculator.this);
        num3.setOnClickListener(Calculator.this);
        num4.setOnClickListener(Calculator.this);
        num5.setOnClickListener(Calculator.this);
        num6.setOnClickListener(Calculator.this);
        num7.setOnClickListener(Calculator.this);
        num8.setOnClickListener(Calculator.this);
        num9.setOnClickListener(Calculator.this);

        dot.setOnClickListener(Calculator.this);
        eql.setOnClickListener(Calculator.this);

        add.setOnClickListener(Calculator.this);
        sub.setOnClickListener(Calculator.this);
        mul.setOnClickListener(Calculator.this);
        div.setOnClickListener(Calculator.this);

        clear.setOnClickListener(Calculator.this);
        about.setOnClickListener(Calculator.this);
        ...
        if (v.getId() == R.id.eql) {
            ...
            switch (v.getId()) {
                ...
                case R.id.div:
                    ...
                    break;
                case R.id.btClear:
                    Intent clear=new Intent(Calculator.this,MainActivity.class);
                    startActivity(clear);
                    break;
                case R.id.btAbout:
                    Intent about=new Intent(Calculator.this,MyTask.class);
                    startActivity(about);
                    break;
                case R.id.btExit:
                    break;
    ...
    {
        AlertDialog.Builder exit=new AlertDialog.Builder(Calculator.this);
