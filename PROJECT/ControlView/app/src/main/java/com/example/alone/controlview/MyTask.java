...
public class MyTask extends ActionBarActivity {
    private Button dateChange, timeChange, add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(MyTask.this, dateSetListener, y, m, d);
        ...
        timeChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(MyTask.this, timeSetListener, h, mn, true);
    ...
    public void loadList() {
        adapter = new ArrayAdapter<String>(MyTask.this, android.R.layout.simple_list_item_1, arr);
